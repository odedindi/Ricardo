...
│   │   ├── constants.js            --> contains the base url and the apiToken variable
│   │   ├── fetches.js              --> the different needed fetch functions for the app
│   │   └── useFetch.jsx            --> a custom useFetch hook that takes no arguments and return [isLoading, data] variables that will auto fit each page
│   │
